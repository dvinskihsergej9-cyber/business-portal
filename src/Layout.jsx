...
const styles = {
  ...
  topBar: {
    ...
    background:
      "linear-gradient(180deg, rgba(255, 255, 255, 0.72), rgba(239, 246, 255, 0.52))",
    backdropFilter: "blur(16px) saturate(1.08)",
    boxShadow: "0 14px 32px rgba(35, 83, 176, 0.1)",
  },
  topBarMobile: {
    position: "sticky",
    top: 0,
    ...
    backdropFilter: "blur(16px) saturate(1.08)",
    boxShadow: "0 10px 24px rgba(35, 83, 176, 0.1)",
  },
  backBtn: {
    minHeight: 34,
    padding: "7px 10px",
    ...
    background:
      "linear-gradient(180deg, rgba(255, 255, 255, 0.78), rgba(239, 246, 255, 0.62))",
    color: "#1e293b",
    fontSize: 13,
    fontWeight: 600,
    display: "inline-flex",
    alignItems: "center",
    gap: 6,
    boxShadow: "0 8px 18px rgba(47, 115, 255, 0.12)",
  },
  topBarLeft: {
    justifySelf: "start",
    display: "inline-flex",
