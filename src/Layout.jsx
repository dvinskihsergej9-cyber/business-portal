...
const styles = {
  ...
  topBar: {
    ...
    alignItems: "center",
    padding: "6px 16px",
    borderBottom: "1px solid rgba(147, 197, 253, 0.56)",
    background:
      "linear-gradient(180deg, rgba(255, 255, 255, 0.48), rgba(239, 246, 255, 0.3))",
    backdropFilter: "blur(18px) saturate(1.08)",
    boxShadow: "0 12px 28px rgba(35, 83, 176, 0.07)",
  },
  topBarMobile: {
    position: "sticky",
    top: 0,
    ...
    borderBottom: "1px solid rgba(147, 197, 253, 0.56)",
    background:
      "linear-gradient(180deg, rgba(255, 255, 255, 0.52), rgba(239, 246, 255, 0.34))",
    backdropFilter: "blur(18px) saturate(1.08)",
    boxShadow: "0 10px 22px rgba(35, 83, 176, 0.07)",
  },
  backBtn: {
    minHeight: 34,
    padding: "7px 10px",
    ...
    background:
      "linear-gradient(180deg, rgba(255, 255, 255, 0.56), rgba(239, 246, 255, 0.38))",
    color: "#1e293b",
    fontSize: 13,
    fontWeight: 600,
    display: "inline-flex",
    alignItems: "center",
    gap: 6,
    boxShadow: "0 8px 18px rgba(47, 115, 255, 0.08)",
  },
  topBarLeft: {
    justifySelf: "start",
    display: "inline-flex",
