...
const styles = {
  ...
  topBar: {
    ...
    alignItems: "center",
    padding: "6px 16px",
    borderBottom: "1px solid rgba(147, 197, 253, 0.28)",
    background: "rgba(255, 255, 255, 0.08)",
    backdropFilter: "blur(18px) saturate(1.08)",
    boxShadow: "0 8px 20px rgba(35, 83, 176, 0.035)",
  },
  topBarMobile: {
    position: "sticky",
    top: 0,
    ...
    backdropFilter: "blur(18px) saturate(1.08)",
    boxShadow: "0 8px 18px rgba(35, 83, 176, 0.035)",
  },
  backBtn: {
    minHeight: 34,
    padding: "7px 10px",
    ...
    alignItems: "center",
    gap: 6,
    boxShadow: "0 6px 14px rgba(47, 115, 255, 0.055)",
  },
  topBarLeft: {
    justifySelf: "start",
    display: "inline-flex",
