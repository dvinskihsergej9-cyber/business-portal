...
function LoginCartAnimation() {
  return (
    <div className="login-hero" aria-hidden="true">
      <svg className="login-hero__scene" viewBox="0 0 760 300" role="img" aria-label="Сотрудник склада с тележкой">
        <path
        ...
        <g className="login-hero__worker-group">
          ...
          <rect x="462" y="138" width="56" height="50" rx="5" className="login-hero__cart-box login-hero__cart-box--dark" />
          ...
          <path d="M551 176l-14 40c-3 8-10 13-18 13h-25v-18h17l8-35z" className="login-hero__person-leg person-leg-light" />
