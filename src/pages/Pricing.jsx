...
const PLAN_CARDS = [
  {
    ...
    currency: "RUB",
    description:
      "Базовый запуск склада для теста и старта команды.",
    highlight: "Пробный запуск",
    available: true,
    features: [
      "До 2 активных сотрудников в компании",
      "Остатки, заявки, задачи, ревизия и транзакции",
      "Мобильный ТСД: приемка, размещение, перемещение, инвентаризация, отбор",
  ...
  },
  {
    ...
    currency: "RUB",
    description:
      "Основной тариф для ежедневной работы и поставок.",
    highlight: "Оптимальный",
    available: true,
    features: [
      "До 5 активных сотрудников в компании",
      "Все возможности тарифа «Старт»",
      "Поставщики и очередь поставок",
      "Расширенный ТСД и заказы клиентов (без модуля расхождений)",
  ...
  },
  {
    ...
    currency: "RUB",
    description:
      "Максимальный доступ для высокой нагрузки и роста команды.",
    highlight: "Максимум",
    available: true,
    features: [
      "Полный доступ ко всем разделам склада",
      "До 20 активных сотрудников в компании",
      "Включая управление складом и модуль расхождений",
