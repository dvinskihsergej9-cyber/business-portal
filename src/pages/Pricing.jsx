...
const PLAN_CARDS = [
  {
    ...
    currency: "RUB",
    description:
      "Тариф знакомства с системой: быстрый запуск склада и проверка процессов на реальных задачах.",
    highlight: "Пробный запуск",
    available: true,
    features: [
      "Один склад и базовые операции (приемка, размещение, отбор)",
      "Мобильный ТСД для основных сканов",
      "Роли сотрудников и SaaS-изоляция данных",
      "Подходит для теста и первичного внедрения",
    ],
  },
  {
    id: "basic-30",
    ...
    currency: "RUB",
    description:
      "Основной тариф для ежедневной работы склада без ограничений по ключевым операциям.",
    highlight: "Оптимальный",
    available: true,
    features: [
      "Полный цикл: приемка, размещение, отбор, отгрузка",
      "Журналы операций, статусы заказов и контроль действий",
      "Фото товара в карточках и рабочих режимах",
      "Подходит для стабильной ежедневной эксплуатации",
    ],
  },
  {
    id: "pro-30",
    ...
    currency: "RUB",
    description:
      "Расширенный тариф для интенсивной работы склада и команд с повышенной нагрузкой.",
    highlight: "Максимум",
    available: true,
    features: [
      "Все возможности тарифа «Базовый»",
      "Приоритетная поддержка и ускоренный разбор инцидентов",
      "Расширенный контроль: hold/freeze, история, аналитика",
      "Для складов с высокой интенсивностью и ростом команды",
    ],
  },
];
